...
class MultiHeadedAttention(nn.Module):
    ...
    def forward_attention(self, value, scores, mask, get_att=False):
        ...
        if get_att:
            # print('scores=',scores)
            return self.linear_out(x), p_attn  # (batch, time1, d_model), (batch, head, time1, time2)
        else:
            return self.linear_out(x)
    def forward(self, query, key, value, mask, get_att=False):
        ...
        return self.forward_attention(v, scores, mask, get_att=get_att)
