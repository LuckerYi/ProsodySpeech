...
class DurationPredictor(torch.nn.Module):
    ...
    def _forward(self, xs, x_masks=None, spembs_=None, is_inference=False, is_f0=False):
    ...
    def inference(self, xs, x_masks=None, spembs_=None, is_f0=False):
        """Inference duration.
        ...
        """
        return self._forward(xs, x_masks, spembs_=spembs_, is_inference=True, is_f0=is_f0)
